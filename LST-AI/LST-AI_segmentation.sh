# Setting Root Folder
ROOTFOLDER=/mnt/hdd/MT/HARMY/HARMY_BL_WMH
...
for_each -nthreads 4 -info $ROOTFOLDER/rawdata/* : lst --t1 IN/NAME_T1w.nii.gz --flair IN/rmNAME_FLAIR.nii.gz --output $ROOTFOLDER/Output/NAME --temp $ROOTFOLDER/temp/NAME --existing_seg $ROOTFOLDER/corrected/ples_lga_0.3_rmNAME_WMH_corrected.nii.gz --device 0 --threads 4
